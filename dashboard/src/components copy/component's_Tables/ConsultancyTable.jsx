...
Row.propTypes = {
  item: PropTypes.shape({
    ...
    numOfTimesRendered: PropTypes.number.isRequired,
    price: PropTypes.number.isRequired,
  }).isRequired,
};

// ConsultancyTable Component Prop Validation
ConsultancyTable.propTypes = {
  handleChange: PropTypes.func.isRequired,
  consultancy_items: PropTypes.arrayOf(
    PropTypes.shape({
      item_id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
      service_id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
      item_name: PropTypes.string.isRequired,
