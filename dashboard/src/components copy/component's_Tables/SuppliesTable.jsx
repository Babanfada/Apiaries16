...
Row.propTypes = {
  suppli: PropTypes.shape({
    supply_id: PropTypes.number.isRequired,
    supply_name: PropTypes.string.isRequired,
    category: PropTypes.string.isRequired,
    quantity: PropTypes.number.isRequired,
    status: PropTypes.string.isRequired,
    storage_location: PropTypes.string.isRequired,
    supplier: PropTypes.string.isRequired,
    minimum_stock_level: PropTypes.number.isRequired,
    purchase_date: PropTypes.string.isRequired,
    purchase_cost: PropTypes.number.isRequired,
    isEdit: PropTypes.bool,
  }).isRequired,
};

SuppliesTable.propTypes = {
  supply: PropTypes.arrayOf(PropTypes.object).isRequired,
