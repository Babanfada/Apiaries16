...
// Define PropTypes for Row component
Row.propTypes = {
  report: PropTypes.shape({
    report_id: PropTypes.string.isRequired,
    hunter_id: PropTypes.string.isRequired,
    assigned_supervisor: PropTypes.string.isRequired,
    total_boxes_assigned: PropTypes.number.isRequired,
    colonized_boxes: PropTypes.number.isRequired,
    uncolonized_boxes: PropTypes.number.isRequired,
    delivered_to_apiary: PropTypes.bool.isRequired,
    date_assigned: PropTypes.string.isRequired,
    catch_date: PropTypes.string.isRequired,
    catch_location: PropTypes.string.isRequired,
    catch_status: PropTypes.string.isRequired,
    season: PropTypes.string.isRequired,
    notes: PropTypes.string,
  }).isRequired,
};

// Define PropTypes for ReportTable component
