...
Row.propTypes = {
  hunter: PropTypes.shape({
    ...
    tip: PropTypes.number.isRequired, // Assuming tip is a number
    employment_status: PropTypes.string.isRequired,
    emergency_contact_name: PropTypes.string.isRequired,
    emergency_contact: PropTypes.string.isRequired,
    notes: PropTypes.string.isRequired,
  }).isRequired,
};

Hunters_Table.propTypes = {
  handleChange: PropTypes.func.isRequired,
  hunters: PropTypes.arrayOf(
    PropTypes.shape({
      hunter_id: PropTypes.string.isRequired,
      assigned_supervisor: PropTypes.string.isRequired,
      fullname: PropTypes.string.isRequired,
  ...
  numOfPages: PropTypes.number.isRequired, // Add validation for numOfPages
  pages: PropTypes.number.isRequired, // Add validation for pages
};